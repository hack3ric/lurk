...
pub struct Riscv64Syscalls {
    _0: [(Sysno, [Option<SyscallArgType>; 6]); 244],
    _260: [(Sysno, [Option<SyscallArgType>; 6]); 35],
    _403: [(Sysno, [Option<SyscallArgType>; 6]); 12],
    _416: [(Sysno, [Option<SyscallArgType>; 6]); 35],
}

impl Index<usize> for Riscv64Syscalls {
    type Output = (Sysno, [Option<SyscallArgType>; 6]);
    ...
    fn index(&self, index: usize) -> &Self::Output {
        match index {
            ...
            416..=450 => &self._416[index - 416],
            _ => panic!("unimplemented syscall index {}", index),
        }
    }
}
